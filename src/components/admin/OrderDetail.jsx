...
const OrderDetail = () => {
  ...
  const { getAllOrder, deleteOrderFunction } = context;
  ...
  return (
    <div>
      {getAllOrder.length > 0 ? (
                        ...
                        return (
                          <tr key={index} className="text-pink-300">
                            ...
                            <td
                              ...
                              className=" text-red-500 h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-pink-100 stroke-slate-50 cursor-pointer "
                            >
                              Delete
                            </td>
                          </tr>
        ...
        <div className="flex justify-center items-center bg-green-600 text-3xl text-white p-4 mt-4 rounded-3xl">
          No Order Yet😢
        </div>
      )}
    </div>
