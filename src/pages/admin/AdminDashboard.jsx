  ...
  return (
    <div>
      <div className="top mb-5 px-5 mt-5">
        <div className=" bg-emerald-600 py-5 border border-pink-100 rounded-lg">
      ...
      <div className="px-5">
        <div className="mid mb-5">
          <div className=" bg-emerald-600 py-5 rounded-xl border border-pink-100">
          ...
          <Tabs>
            <TabList className="flex flex-wrap -m-4 text-center justify-center">
              <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                <div className=" border bg-emerald-600 hover:bg-emerald-800 border-pink-100 px-4 py-3 rounded-xl">
              ...
              <Tab className="p-4 md:w-1/4 sm:w-1/2 w-full cursor-pointer">
                <div className=" border bg-emerald-600 hover:bg-emerald-800 border-pink-100 px-4 py-3 rounded-xl">
                  ...
                  <h2 className="title-font font-medium text-3xl text-white fonts1">
                    {getAllOrder ? getAllOrder.length : "No Order Yet"}
                  </h2>
