  ...
  return (
    <Layout>
      <div className=" container mx-auto px-4 py-5 lg:py-8">
        <div className="top ">
          <div className=" bg-gray-900 py-5 text-white rounded-xl border border-pink-100">
                    ...
                    {order.cartItems.map((item, index) => {
                      ...
                      return (
                        <>
                          ...
                          >
                            <div className="w-full border-r border-pink-100 bg-gray-100 md:max-w-xs">
                              <div className="p-8">
